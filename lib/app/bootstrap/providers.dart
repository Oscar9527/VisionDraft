...
final projectWorkspaceRepositoryProvider =
    Provider<ProjectWorkspaceRepository>((ref) {
...
final projectLibraryRepositoryProvider = Provider<ProjectLibraryRepository>((ref) {
  return DriftProjectLibraryRepository(
    storageService: ref.watch(appStorageServiceProvider),
    bundleService: ref.watch(projectBundleServiceProvider),
    workspaceRepository:
        ref.watch(projectWorkspaceRepositoryProvider) as DriftProjectWorkspaceRepository,
    indexDatabaseFactory: ref.watch(appIndexDatabaseFactoryProvider),
...
final assetFingerprintServiceProvider = Provider<AssetFingerprintService>((ref) {
  return const AssetFingerprintService();
});

final assetHealthCheckUseCaseProvider = Provider<AssetHealthCheckUseCase>((ref) {
...
final workspaceControllerProvider = NotifierProvider.family<
    ProjectWorkspaceController, ProjectWorkspaceSnapshot, String>(
